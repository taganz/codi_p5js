"use strict";
const SKETCH_NAME = "triangle_network_5";
let canvas_size = 800;
let palette;
let arr_dots;
let color_dots_1;
...
function setup() {
    ...
    sliders_add(2, 35, 18, 1, "x");	// 0
    sliders_add(2, 20, 13, 1, "y");	
    sliders_add(20, 35, 26, 1, "z");	
    sliders_add(0, 70, 29, 1, "dots_strokeWeight"); // 3
    sliders_add(0, 10, 7, 1, "palette_id"); // 4
    sliders_add(0, 10, 1, 1, "lines_strokeWeight"); // 5
    sliders_add(0, 2, 1, 1, "color_mode"); 
    
    palette = fixed_palette(palette_id);
    palette_old = palette;
    fill(fixed_color(0, palette_id));
    change_palette();
    
    arr_dots = grid_create(x, y, z, width);
...
function change_palette() {
    switch(color_mode) {
        ...
        case 1:
            ...
            color_line_other_row = fixed_color(4, palette);
            color_background = fixed_color(0, palette);
            break;
        case 0:
            // 0 = random color lines
        default:
            color_dots_1 = random_color(palette);
            color_dots_2 = random_color(palette);
            color_line_same_row = random_color(palette);
            color_line_other_row = random_color(palette);
            color_background = random_color(palette);
    }
