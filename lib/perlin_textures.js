...
function perlin_triangle(x1, y1, x2, y2, x3, y3, col, k, pixel_size, color_range=30) {
...
function perlin_triangle_3(x1, y1, x2, y2, x3, y3, color, k, pixel_size, color_range=30) {
    // bounding box
