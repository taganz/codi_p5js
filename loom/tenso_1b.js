...
function setup() {
    ...
    sliders_activate();
    sliders_add(6, 20, 7, 1, "ROWS");
    sliders_add(3, 250, 60, 1, "DOTS_ROW");
    sliders_add(1, 60, 25, 1, "WEIGHT");
    sliders_add(0.1, 3, 0.7, 0.1, "STRING_WEIGHT_RATIO");
    sliders_add(0, 10, 0.1, 0.1, "OSCILLATION_X");
    sliders_add(0, 30, 2.9, 0.1, "OSCILLATION_Y");
    sliders_add(1, 100, 86, 1, "PERIOD_X");
    sliders_add(1, 100, 91, 1, "PERIOD_Y");
    sliders_add(1, 5, 2.8, 0.1, "AMPLITUDE_FACTOR_X");
    sliders_add(1, 5, 2.8, 0.1, "AMPLITUDE_FACTOR_Y");
    ...
    move() {
        ...
        for (let row = 1; row < a.length; row++){       
            ...
            for (let i = 0; i < a[row].length; i++ ) {
                ...
                a[row][i].x +=  amp_x * Math.sin(TWO_PI * step / PERIOD_X +  a[row][i].phase);   
                a[row][i].y +=  amp_y * Math.sin(TWO_PI * step / PERIOD_Y + i/osc_y_x + a[row][i].phase);   
            }
        }
    }
