...
function setup() {
    ...
    sliders_activate();
    sliders_add(13, 20, 17, 1, "ROWS");
    sliders_add(3, 250, 134, 1, "DOTS_ROW");
    sliders_add(1, 60, 27, 1, "WEIGHT");
    sliders_add(0.1, 3, 0.5, 0.1, "STRING_WEIGHT_RATIO");
    sliders_add(0, 10, 5.3, 0.1, "OSCILLATION_X");
    sliders_add(0, 30, 12.5, 0.1, "OSCILLATION_Y");
    sliders_add(1, 60, 5, 1, "FREQUENCY_X");
    sliders_add(1, 60, 33, 1, "FREQUENCY_Y");
    sliders_add(1, 5, 5, 0.1, "AMPLITUDE_FACTOR_X");
    sliders_add(1, 5, 4.1, 0.1, "AMPLITUDE_FACTOR_Y");
