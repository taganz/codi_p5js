...
function setup() {
    ...
    OPC.slider("ROWS",         16, 2, 30, 1);
    OPC.slider("DOTS_ROW",     28, 3, 50, 1);
    OPC.slider("MOVE_MODE",    2, 0, 5, 1);  // 0.no move, 1.basic, 2, xx, 3, xx, 4, curtain, 5, no funciona
    OPC.slider("MOVE_MODE_SPEED", 150, 100, 1000, 1);
    OPC.slider("_______b", 999, 999, 999);
    ...
    OPC.slider("___work", 999, 999, 1000, 1);
    ...
    OPC.slider("OSCILLATION_Y", 9, 0, 30,  0.1);
    OPC.slider("PERIOD_X",      170, 50, 250,  1);
    OPC.slider("PERIOD_Y",      19050, 50, 250,  1);
