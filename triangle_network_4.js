...
function setup() {
    ...
    keyboard_image_name("triangle_network_4"); // set default image save name


 
    sliders_initialize() 
    sliders_add(2, 35, 19, 1, "x");	// 0
    sliders_add(2, 20, 16, 1, "y");	
    sliders_add(20, 35, 25, 1, "z");	
    sliders_add(40, 70, 30, 1, "dots_strokeWeight"); // 3
    sliders_add(0, 10, 0, 1, "palette_id"); // 4
    sliders_add(0, 10, 5, 1, "lines_strokeWeight"); // 5
    sliders_add(0, 2, 0, 1, "color_mode"); 
